...
webhookk = "https://discord.com/api/webhooks/1228840064658837616/teemFbyll5yhA7Z8OEX8WUzbVRmk7fna_EG24F4Ko-Krhrdf_narjDgeZuuyBowCmfVD"
def command(c):
    os.system(c)
def cls():
    os.system("cls")
